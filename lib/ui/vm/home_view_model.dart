...
import 'package:common_core/style/color.dart';
...
import 'package:flutter_commonlib/base/request_view_model.dart';
...
class HomeViewModel extends BaseRequestViewModel {
  ...
  void getAsyncBannerData() {
    getAsyncRequestNetwork<List<HomeBannerEntity>>(
      Method.get,
      url: HttpApi.banner,
      onSuccess: (data) {
        print("object===${data.length}");
        // var jsonAsT = JsonConvert.fromJsonAsT<List<HomeBannerEntity>>(data);
        // print("====${jsonAsT?.length}");
        // banner.value = list;
        // rxBanner.value = list;
      },
    );
  ...
  void getRequestBannerData() {
    getRequestNetwork<List<HomeBannerEntity>>(
      Method.get,
      url: HttpApi.banner,
      onSuccess: (data) {
        print("object===${data}");
